...
function CreateNote() {
  ...
  return (
    <div className="relative bg-neutral-50 border border-solid border-zinc-100 border-2 rounded-xl mt-4 w-128 h-50 pt-4">
      <form className="flex flex-col items-start pl-7">
        <input
        ...
        />
        <button className="absolute bottom-1 right-8 border border-solid rounded-xl w-16 h-6 bg-gray-700 text-white text-sm font-quicksand">
          Add
        </button>
      </form>
    </div>
